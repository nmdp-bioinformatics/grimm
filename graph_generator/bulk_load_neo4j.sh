...
NEO4J_ACTIVE_DATABASE=graphimputewmda.db
GRAPH_PATH=${DATA_HOME}/databases/${NEO4J_ACTIVE_DATABASE}
IMPORT_PATH=${DATA_HOME}/csv
...
${NEO4J_IMPORT_CMD} --into ${GRAPH_PATH} \
	--id-type INTEGER \
	--nodes ${IMPORT_PATH}/nodes.csv \
    --relationships ${IMPORT_PATH}/top_links.csv \
	--relationships ${IMPORT_PATH}/edges.csv
